...
Визуализатор алгоритмов. Эта проектная работа заточена на анимацию и поэтапное отображение работы алгоритма, что позволит детальнее понять каждый шаг его работы.
...
**ЗАПУСК ПРОЕКТА**
Нужно скачать или клонировать проект.
Далее:
```sh
npm i 
```
